describe('The Home page', function () {
  ...
  l10n(() => {
    it('should display the title', function () {
      ...
      cy.get('#banner > h1').should('have.length', 1).should('be.visible').should('have.text', this.t.header.title)
    })
    ...
    describe('The search form', function () {
      it('should be visible', function () {
        ...
        cy.get('form[action*="/record"]')
          ...
          .within(() => {
            ...
            cy.get('button[type=submit]').should('be.visible').should('have.text', this.t.facets.go_button)
          })
      })
      ...
      it('should post to the publication page', function () {
        ...
        cy.get('#publ h3').first().should('be.visible').should('contain', `1 ${this.t.hits.publication}`)

        cy.get('a[href$="/record/2737391"]').should(
          'contain',
